                    ...
                    <div className="col-md-6 col-lg-4 mb-4" key={cuidador.id}>
                      ...
                      >
                        <div className="card-body d-flex flex-column justify-content-between align-items-center">
                          {/* Foto do cuidador */}
                          <img
                            src={cuidador.User?.fotoPerfil || "../src/assets/perfil.png"}
                          ...
                          <div className="">
                            ...
                            <p><strong>Valor Diária:</strong> <span className="badge bg-success">R$ {cuidador.valorHora}</span></p>
                          </div>
                          ...
                          <div className="mt-3 d-flex justify-content-center gap-2">
                            <a
                              ...
                              onClick={() => localStorage.setItem("cuidadorId", cuidador.id)}
                            >
