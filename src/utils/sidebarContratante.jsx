        ...
        >
          ...
          <ul className="nav flex-column p-3">
            ...
            <li className="nav-item">
              ...
              >
                <FaHome /> <span className="ms-2">Início</span>
              </button>
            </li>
            <li className="nav-item">
              <button
        ...
        <ul className="nav nav-pills flex-column px-2 mt-3">
          <li>
            <Link to="/paciente/encontrar" className="nav-link text-white">
              <FaSearch />
              {!collapsed && <span className="ms-2">Encontrar cuidador</span>}
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/paciente/agendamentos" className="nav-link text-white">
              <FaCalendarAlt />
